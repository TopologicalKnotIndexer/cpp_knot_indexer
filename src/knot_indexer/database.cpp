...
NameNormalizer::NameNormalizer(const std::filesystem::path& dataDir) {
...
bool NameNormalizer::isAmphichiralPrime(const std::string& rawPrimeName) const {
...
std::string NameNormalizer::regularizePrime(const std::string& knotName) const {
...
std::string NameNormalizer::simplifyPrime(const std::string& knotName) const {
    if (!isPrimeNameFormat(knotName)) return normalizeK(knotName);
    std::string normalized = normalizeK(knotName);
...
std::string NameNormalizer::normalize(const std::string& knotName) const {
