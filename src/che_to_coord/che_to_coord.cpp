...
CoordinateLoop parseCoordinateLoopText(const std::string& text, const ParseOptions& options) {
...
CoordinateLoop readCoordinateLoopFile(const std::filesystem::path& path, const ParseOptions& options) {
